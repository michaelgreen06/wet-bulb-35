...
- Step 4: production Worker redeployed from `main` (assets built with Places key), version `a4b4fd85`, 2026-09-12T14:41Z. No route attached. `OPENWEATHER_API_KEY` still set.
