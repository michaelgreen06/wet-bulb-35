...
- The weather formula preserves production's clamped calculation inputs while retaining original temperature/humidity readings in the response. Tests cover saturated air, very dry air, cold/hot readings, and cache reuse without additional provider calls.
